...
private JButton exit = new JButton("Exit");
	...
	public InsuranceDetails(){
		...
		for (int width_reg_labels = 30, count_login_label = 0; count_login_label < 7; count_login_label++){
			...
			table_header[count_login_label].setFont(new Font("Serif", Font.BOLD, 14));
		...
		payment.setBounds(163, 530, 160, 27);
	...
	public void actionPerformed(ActionEvent e){
		if(e.getSource()==saveinsurance)  
        {
			...
			if(isFieldEmpty){
				...
				table_textfields[5].setBackground(new Color(255, 255, 179));
				}
			}
        }
        	...
        	if(!table_textfields[5].getText().isEmpty()){
        		...
        		JOptionPane.showMessageDialog(this,"Success! You Reg. Application is now Verified.\nYour Application Number is: "+table_textfields[1].getText()
        		+"\nVehicle No: "+table_textfields[3].getText()+"\nMovement Number: "+table_textfields[4].getText());
        	}
        }
			...
			int a=JOptionPane.showConfirmDialog(this,"Are you want to Exit ?");
			if(a==JOptionPane.YES_OPTION){
				dispose();
			}
		}
