...
protected JTextField search_textfields[] = new JTextField[5];
private JTextField owner_textfields[] = new JTextField[20];

private String reg_labels[] = {"Chassis Number","Engine/ Motor Number"};
private String owner_labels_str[] = {"Registration Type","Purchase/Delivery Date","Owner Name","Ownership Type","Son/Wife/Daughter of","Ownership Serial","Owner Category","Mobile No","Email Id","PAN No","Aadhaar No","Passport No","Ration Card No","Voter Id","Address"};
...
private JButton logout = new JButton("Logout");
	...
	private void header(){
		JLabel header = new JLabel("OWNER INFORMATION",JLabel.CENTER);
	...
	public void actionPerformed(ActionEvent e){
		if(e.getSource() == inward){
			if(search_textfields[0].getText().isEmpty() || search_textfields[1].getText().isEmpty()){
				...
				if(isFieldEmpty){
					...
					if(a==JOptionPane.YES_OPTION){
						new VehiclesDetails(search_textfields[0].getText(),search_textfields[1].getText());
						dispose();				
					}
			...
			JOptionPane.showMessageDialog(this,"Chassis Number: "+search_textfields[0].getText()+
				"\nEngine/ Motor Number: "+search_textfields[1].getText()+"\nYou can fill up your details now.");
		}
