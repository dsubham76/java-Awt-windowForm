...
private String vehile_labels_str[] = {"Maker","Chassis No","Vehicle Category","Seating Capacity","Landen Weight(Kg)","Color","Body Type","Manufacture Month","Audio Fitted","Maker Model","Vehile Type","Fuel","No of Cylinders","Norms","Cubic Capacity","Video Fitted","Dealer","Vehile Class","Engine/Motor No","Unlanden Weight(Kg)","Purchase As","AC Fitted","Manufacture Year","Sale Amount","Other Criteria","Imported Vehicle","Manufactured Location"};
private String makers[] = {"MAKER1 LTD","MAKER2 LTD","MAKER3 LTD","MAKER4 LTD"};
private String makers_model[] = {"MODEL1","MODEL2","MODEL3","MODEL4"};
private String dealers[] = {"DEALER_A","DEALER_B","DEALER_C","DEALER_D"};
...
private String norms[] = {"BHARAT STAGE I","BHARAT STAGE II","BHARAT STAGE III","BHARAT STAGE IV"};
...
// private String engineNo = "";
	//Constructor
	public VehiclesDetails(String chasis, String engineNo){
		...
		for (int width_vehicle_labels = 20,height=50,count = 0; count < 27; count++){
			...
			if(count==0){
				...
				vehicle_textfields[count].setText(chasis);
				...
				vehicle_textfields[count] = new JTextField();
				vehicle_textfields[count].setBounds(width_vehicle_labels, height, 200, 25);
				vehicle_textfields[count].setText(engineNo);
				vehicle_textfields[count].setFont(new Font("Serif", Font.PLAIN, 15));
				vehicle_textfields[count].setBackground(new Color(233, 252, 251));
				add(vehicle_textfields[count]);	
			}
	...
	private void header(){
		JLabel header = new JLabel("VEHICLE INFORMATION",JLabel.CENTER);
