...
public class OnlineCounselling extends JFrame {
    ...
    OnlineCounselling(){
        ...
        // Set Title text to a pane in Heading
        ...
        "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"+
        "&nbsp;&nbsp;"+
        "ONLINE COUNSELLING SYSTEM</h2>");
		myPane.setBounds(40,40,130,30);
		jf.setContentPane(myPane);
        ...
        JLabel r_phone= new JLabel("PHONE NUMBER");
        ...
        JButton r_reset_btn = new JButton("RESET");
        ...
        day.setBounds(170,340,50,20);
        month.setBounds(230,340,50,20);
        year.setBounds(290,340,60,20);
        ...
        JLabel stream_select = new JLabel("SELECT COLLEGE");
	...
	public static void main(String [] args){
        ...
        // Call to the default contructor OnlineCounselling

		OnlineCounselling o = new OnlineCounselling();
